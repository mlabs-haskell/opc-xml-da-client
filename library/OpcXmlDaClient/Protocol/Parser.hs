{-# LANGUAGE DeriveAnyClass, PolyKinds, QuantifiedConstraints #-}

{-# LANGUAGE KindSignatures, NamedFieldPuns, StandaloneKindSignatures #-}
...
parse document | let
  cursor = Cursor.fromDocument document
